...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument_list, 5, 0, 0),
  [21] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_argument_list, 5, 0, 0),
  ...
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(77),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_else_clause, 3, 0, 0), SHIFT(88),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(77),
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(88),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [152] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_else_if_clause, 5, 0, 15), SHIFT(88),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_block, 1, 0, 0), SHIFT(88),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_block, 1, 0, 0), SHIFT(77),
  ...
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 2, 0, 8), SHIFT_REPEAT(74),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 2, 0, 8), SHIFT_REPEAT(95),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 7, 0, 9),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_statement, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_statement, 7, 0, 10),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 8, 0, 11),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 8, 0, 12),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 8, 0, 13),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_statement, 8, 0, 14),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 9, 0, 16),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 9, 0, 17),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 9, 0, 18),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 10, 0, 21),
  ...
  [221] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 0), SHIFT_REPEAT(70),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 0),
  [226] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(71),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0),
  ...
  [245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(76),
  [248] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(76),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0),
  ...
  [263] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 2, 0, 7), SHIFT_REPEAT(116),
  [266] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [268] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  ...
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 19),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 1, 0, 6),
  [289] = {.entry = {.count = 1, .reusable = true}}, SHIFT(119),
  [291] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 4, 0, 0),
  ...
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 1, 0, 5),
  ...
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_clause, 6, 0, 20),
