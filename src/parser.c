...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_identifier_character_set_2, 685, lookahead)) ADVANCE(65);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 9,
    ...
    case 56:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(65);
      END_STATE();
    case 57:
      ACCEPT_TOKEN(sym_identifier);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [21] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  ...
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 2),
  ...
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  ...
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 4),
  ...
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 4, 0, 5),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 4, 0, 5),
  ...
  [156] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  [159] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(85),
  [162] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [167] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(85),
  [170] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(85),
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 11), SHIFT(69),
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 11), SHIFT(85),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 16), SHIFT(85),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 11), SHIFT(69),
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 11), SHIFT(85),
  [194] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 20), SHIFT(85),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 21),
  ...
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 9), SHIFT_REPEAT(75),
  [210] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 9), SHIFT_REPEAT(90),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 10),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 7, 0, 11),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 12),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 13),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 14),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 8, 0, 15),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 17),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 18),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 19),
  ...
  [263] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(74),
  [266] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(74),
  ...
  [281] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [284] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 8), SHIFT_REPEAT(111),
  ...
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 1, 0, 7),
  ...
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 6),
