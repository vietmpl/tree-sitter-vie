...
enum ts_symbol_identifiers {
  ...
  sym_source_file = 28,
  sym__node = 29,
  sym_comment_block = 30,
  sym_render_block = 31,
  sym__statement = 32,
  sym_if_block = 33,
  sym__else_if_clause = 34,
  sym__else_clause = 35,
  sym_boolean_literal = 36,
  sym__literal = 37,
  sym_arguments = 38,
  sym_call_expression = 39,
  sym_pipe_expression = 40,
  sym_unary_expression = 41,
  sym_binary_operator = 42,
  sym_binary_expression = 43,
  sym__parenthesized_expression = 44,
  sym__expression = 45,
  aux_sym_source_file_repeat1 = 46,
  aux_sym_comment_block_repeat1 = 47,
  aux_sym_if_block_repeat1 = 48,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_identifier_character_set_2, 685, lookahead)) ADVANCE(44);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 7,
    ...
    case 37:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(44);
      END_STATE();
    case 38:
      ACCEPT_TOKEN(sym_identifier);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 4),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 2),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 2),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 1),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 1),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 3, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 3, 0, 0),
  ...
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [112] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(69),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(69),
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 11), SHIFT(69),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [142] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 15), SHIFT(69),
  ...
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 3, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 7),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 14),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 10),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 12),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 8),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 13),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 9),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 16),
  ...
  [197] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [200] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [207] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 6), SHIFT_REPEAT(68),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 5),
