...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 4:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(4);
      if (set_contains(sym_identifier_character_set_2, 684, lookahead)) ADVANCE(69);
      END_STATE();
    case 5:
      ADVANCE_MAP(
        '!', 10,
    ...
    case 60:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(69);
      END_STATE();
    case 61:
      ACCEPT_TOKEN(sym_identifier);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_render_block] = STATE(45),
    [sym__statement] = STATE(45),
    [sym_if_block] = STATE(45),
    [sym_switch_block] = STATE(45),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 7),
  ...
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3, 0, 4),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3, 0, 4),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 6),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 6),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 7),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 5, 0, 0),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 5, 0, 0),
  ...
  [131] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  ...
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 22), SHIFT(96),
  [148] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(96),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(96),
  [156] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 13), SHIFT(75),
  [159] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 13), SHIFT(96),
  [162] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [164] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 18), SHIFT(96),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 13), SHIFT(75),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 13), SHIFT(96),
  [175] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [183] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5), SHIFT_REPEAT(112),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5), SHIFT_REPEAT(55),
  ...
  [197] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5), SHIFT_REPEAT(126),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5),
  [202] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5), SHIFT_REPEAT(57),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 3, 0, 0),
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 11), SHIFT_REPEAT(82),
  [210] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 11), SHIFT_REPEAT(122),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 12),
  ...
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 7, 0, 13),
  [225] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [227] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 14),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 15),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 16),
  [235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 8, 0, 17),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 19),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 20),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 21),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 23),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  ...
  [275] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [278] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0),
  ...
  [291] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 1, 0, 2),
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 1, 0, 2),
  [295] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  ...
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 2),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 2),
  [306] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 10), SHIFT_REPEAT(113),
  ...
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 1, 0, 9),
  ...
  [355] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 8),
