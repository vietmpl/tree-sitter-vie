...
enum ts_symbol_identifiers {
  ...
  aux_sym_if_block_repeat1 = 54,
  aux_sym_switch_block_repeat1 = 55,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_identifier_character_set_2, 685, lookahead)) ADVANCE(55);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 8,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym__node] = STATE(25),
    [sym_comment_block] = STATE(25),
    [sym_render_block] = STATE(25),
    [sym__statement] = STATE(25),
    [sym_if_block] = STATE(25),
    [sym_switch_block] = STATE(25),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 4),
  [67] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 4),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 2),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 2),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 1),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 1),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 4, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_arguments, 4, 0, 0),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  [133] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 15), SHIFT(82),
  [136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 10), SHIFT(65),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 10), SHIFT(82),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(82),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [149] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(82),
  [152] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(65),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(82),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [160] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 19), SHIFT(82),
  ...
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_operator, 1, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_operator, 1, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operator, 1, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_operator, 1, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 20),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 8), SHIFT_REPEAT(70),
  [194] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 8), SHIFT_REPEAT(107),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 9),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 7, 0, 10),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 3, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 11),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 12),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 13),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 8, 0, 14),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 16),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 17),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 18),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  ...
  [241] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [244] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0),
  ...
  [267] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [270] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 7), SHIFT_REPEAT(94),
  ...
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 5),
