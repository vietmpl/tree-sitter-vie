...
enum ts_symbol_identifiers {
  ...
  sym_pipe_expression = 58,
  sym_unary_expression = 59,
  sym_binary_expression = 60,
  sym__parenthesized_expression = 61,
  sym__expression = 62,
  aux_sym_source_file_repeat1 = 63,
  aux_sym_comment_block_repeat1 = 64,
  aux_sym_if_block_repeat1 = 65,
  aux_sym_switch_block_repeat1 = 66,
  aux_sym_string_literal_repeat1 = 67,
  aux_sym_string_literal_repeat2 = 68,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 4:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(4);
      if (set_contains(sym_identifier_character_set_2, 684, lookahead)) ADVANCE(66);
      END_STATE();
    case 5:
      ADVANCE_MAP(
        '!', 10,
    ...
    case 57:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(66);
      END_STATE();
    case 58:
      ACCEPT_TOKEN(sym_identifier);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_render_block] = STATE(47),
    [sym__statement] = STATE(47),
    [sym_if_block] = STATE(47),
    [sym_switch_block] = STATE(47),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 6),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 6),
  ...
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 1),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 1),
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 3),
  ...
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3, 0, 4),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3, 0, 4),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 7),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 4, 0, 8),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 4, 0, 8),
  ...
  [143] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  [146] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [151] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 23), SHIFT(96),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(96),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [159] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(96),
  [162] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 14), SHIFT(82),
  [165] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 14), SHIFT(96),
  [168] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [170] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 19), SHIFT(96),
  [173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 14), SHIFT(82),
  [178] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 14), SHIFT(96),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 21),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  ...
  [197] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 12), SHIFT_REPEAT(84),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 12), SHIFT_REPEAT(127),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 13),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 3, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 7, 0, 14),
  ...
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 24),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 15),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 16),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 17),
  [229] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5), SHIFT_REPEAT(129),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5),
  [234] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 5), SHIFT_REPEAT(70),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 8, 0, 18),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 22),
  [247] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5), SHIFT_REPEAT(128),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5),
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 5), SHIFT_REPEAT(76),
  ...
  [271] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [274] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0),
  ...
  [297] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_escape_sequence, 2, 0, 0),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_escape_sequence, 2, 0, 0),
  [301] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat2, 1, 0, 2),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 1, 0, 2),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 2),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 1, 0, 2),
  [309] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [311] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 11), SHIFT_REPEAT(118),
  [314] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  ...
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 1, 0, 10),
  ...
  [343] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 9),
