...
enum ts_symbol_identifiers {
  ...
  sym_source_file = 35,
  sym__node = 36,
  sym_comment_block = 37,
  sym_render_block = 38,
  sym__statement = 39,
  sym_if_block = 40,
  sym__else_if_clause = 41,
  sym__else_clause = 42,
  sym_switch_block = 43,
  sym__case_clause = 44,
  ...
  aux_sym_comment_block_repeat1 = 57,
  aux_sym_if_block_repeat1 = 58,
  aux_sym_switch_block_repeat1 = 59,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1);
      if (set_contains(sym_identifier_character_set_2, 685, lookahead)) ADVANCE(64);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '!', 8,
    ...
    case 55:
      ...
      if (set_contains(sym_identifier_character_set_3, 800, lookahead)) ADVANCE(64);
      END_STATE();
    case 56:
      ACCEPT_TOKEN(sym_identifier);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_render_block] = STATE(35),
    [sym__statement] = STATE(35),
    [sym_if_block] = STATE(35),
    [sym_switch_block] = STATE(35),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 4),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 4),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__parenthesized_expression, 3, 0, 0),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pipe_expression, 3, 0, 3),
  ...
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0),
  ...
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  [140] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [143] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(79),
  [146] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [149] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 3, 0, 0), SHIFT(79),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_clause, 4, 0, 0), SHIFT(79),
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 10), SHIFT(69),
  [160] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 10), SHIFT(79),
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 6, 0, 19), SHIFT(79),
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__else_if_clause, 5, 0, 15), SHIFT(79),
  [169] = {.entry = {.count = 1, .reusable = true}}, SHIFT(40),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(69),
  [174] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 10), SHIFT(79),
  [177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_operator, 1, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_operator, 1, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operator, 2, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_operator, 2, 0, 0),
  ...
  [195] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 8), SHIFT_REPEAT(71),
  [198] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 2, 0, 8), SHIFT_REPEAT(109),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 3, 0, 0),
  [203] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 7, 0, 9),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 2, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_block, 2, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 7, 0, 10),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_block, 3, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 12),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 13),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 16),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 17),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 9, 0, 18),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 8, 0, 11),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_block, 8, 0, 14),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_block, 10, 0, 20),
  ...
  [245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [248] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_block_repeat1, 2, 0, 0),
  ...
  [275] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 2, 0, 7), SHIFT_REPEAT(104),
  [278] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  ...
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_block_repeat1, 1, 0, 6),
  ...
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_block_repeat1, 1, 0, 5),
