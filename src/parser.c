...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_else_if_clause, 5, 0, 12), SHIFT(76),
  ...
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_else_clause, 3, 0, 0), SHIFT(85),
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 8), SHIFT(72),
  [150] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__case_clause, 4, 0, 8), SHIFT(85),
  [153] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_block, 1, 0, 0), SHIFT(85),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_block, 1, 0, 0), SHIFT(72),
  ...
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 2, 0, 6), SHIFT_REPEAT(71),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 2, 0, 6), SHIFT_REPEAT(101),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 7, 0, 7),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_render_statement, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_statement, 7, 0, 8),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 3, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 8, 0, 9),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 8, 0, 10),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_switch_statement, 8, 0, 11),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 9, 0, 13),
  ...
  [197] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2, 0, 0),
  ...
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 0), SHIFT_REPEAT(65),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat2, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [221] = {.entry = {.count = 1, .reusable = false}}, SHIFT(83),
  [223] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(68),
  [226] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0), SHIFT_REPEAT(68),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_repeat1, 2, 0, 0),
  ...
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [252] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [254] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_else_if_clause, 6, 0, 15), SHIFT(98),
  ...
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_switch_statement_repeat1, 1, 0, 5),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__case_clause, 5, 0, 14),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_clause, 6, 0, 16),
  ...
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_clause, 7, 0, 17),
  [297] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [299] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 4, 0, 0),
